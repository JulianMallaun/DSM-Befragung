...
Die Angaben werden anonymisiert ausschließlich zu wissenschaftlichen Zwecken genutzt. Geschätzte Dauer: 20–30 Minuten.
""")
...
def device_form(device_name: str):
    ...
    # --- Kriterien mit Bedeutungen (klein & grau via caption) ---
